...
<body>
	...
	<div class="sidebar">
		...
		<a href="viewCabs">View Cabs</a> <a
			href="${pageContext.request.contextPath}/AddCabServlet">Add New
			Cab</a>
	</div>
					...
					<c:forEach var="cab" items="${cabs}">
						<tr>
							...
							<td class="action-buttons"><a
								href="EditCabServlet?id=${cab.id}" class="edit-btn">Edit</a> <a
								href="DeleteCabServlet?id=${cab.id}" class="delete-btn"
